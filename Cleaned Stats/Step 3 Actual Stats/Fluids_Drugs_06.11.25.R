...
# 
# ### A. VASOPRESSIN as DV
# renal_30 %>% group_by(HemorrhageGroup) %>%
#   shapiro_test(CumulativeVasopressin)
# 
...
# 
# # ------------------------------
# # OPTIONAL: Non-parametric fallback (ART)
# # ------------------------------
# # Example for Vasopressin if residuals not normal:
# art_vaso <- art(CumulativeVasopressin ~ HemorrhageGroup + Gender + Weightkg, data = renal_30)
